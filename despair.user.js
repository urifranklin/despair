// ==UserScript==
// @name          despair - change history.
// @description   UI extender to stop regretting thepast
// @namespace     https://github.com/urifranklin/despair
// @version       1.1
// @match         https://discord.com/*
// @downloadURL   https://raw.githubusercontent.com/urifranklin/despair/master/despair.user.js
// @homepageURL   https://github.com/urifranklin/despair
// @supportURL    https://github.com/urifranklin/despair/issues
// @contributionURL https://goatse.cx
// @grant         none
// @license       MIT
// ==/UserScript==
 ...
 * @author Uri Franklin <https://github.com/urifranklin/despair>
 * @see https://github.com/urifranklin/despair
 */
...
function initUI() {
    ...
    insertCss(`
        #despair-btn{position: relative; height: 24px;width: auto;-webkit-box-flex: 0;-ms-flex: 0 0 auto;flex: 0 0 auto;margin: 0 8px;cursor:pointer; color: var(--interactive-normal);}
        #despair{position:fixed;top:100px;right:10px;bottom:10px;width:780px;z-index:99;color:var(--text-normal);background-color:var(--background-secondary);box-shadow:var(--elevation-stroke),var(--elevation-high);border-radius:4px;display:flex;flex-direction:column}
        #despair a{color:#00b0f4}
        #despair.redact .priv{display:none!important}
        #despair:not(.redact) .mask{display:none!important}
        #despair.redact [priv]{-webkit-text-security:disc!important}
        #despair .toolbar span{margin-right:8px}
        #despair button,#despair .btn{color:#fff;background:#7289da;border:0;border-radius:4px;font-size:14px}
        #despair button:disabled{display:none}
        #despair input[type="text"],#despair input[type="search"],#despair input[type="password"],#despair input[type="datetime-local"],#despair input[type="number"]{background-color:#202225;color:#b9bbbe;border-radius:4px;border:0;padding:0 .5em;height:24px;width:144px;margin:2px}
        #despair input#file{display:none}
        #despair hr{border-color:rgba(255,255,255,0.1)}
        #despair .header{padding:12px 16px;background-color:var(--background-tertiary);color:var(--text-muted)}
        #despair .form{padding:8px;background:var(--background-secondary);box-shadow:0 1px 0 rgba(0,0,0,.2),0 1.5px 0 rgba(0,0,0,.05),0 2px 0 rgba(0,0,0,.05)}
        #despair .logarea{overflow:auto;font-size:.75rem;font-family:Consolas,Liberation Mono,Menlo,Courier,monospace;flex-grow:1;padding:10px}
    `);

    popover = createElm(`
    <div id="despair" style="display:none;">
        <div class="header">
            despair - change history
        </div>
        <div class="form">
            <div style="display:flex;flex-wrap:wrap;">
                <span>Authorization <a
                        href="https://github.com/urifranklin/despair/blob/master/help/authToken.md" title="Help"
                        target="_blank">?</a> <button id="getToken">get</button><br>
                    <input type="password" id="authToken" placeholder="Auth Token" autofocus>*<br>
                    <span>Author <a href="https://github.com/urifranklin/despair/blob/master/help/authorId.md"
                ...
                <span>Guild/Channel <a
                        href="https://github.com/urifranklin/despair/blob/master/help/channelId.md" title="Help"
                        target="_blank">?</a>
                ...
                <span>Range <a href="https://github.com/urifranklin/despair/blob/master/help/messageId.md"
                ...
                <span>Search messages <a
                        href="https://github.com/urifranklin/despair/blob/master/help/filters.md" title="Help"
                        target="_blank">?</a><br>
                ...
                <span>Search Delay <a
                href="https://github.com/urifranklin/despair/blob/master/help/delay.md" title="Help"
                target="_blank">?</a><br>
        ...
        <pre class="logarea">
            <center>Star this project on <a href="https://github.com/urifranklin/despair" target="_blank">github.com/urifranklin/despair</a>!\n\n
                <a href="https://github.com/urifranklin/despair/issues" target="_blank">Issues or help</a>
            </center>
        </pre>
    </div>
    `);
