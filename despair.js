...
(function () {
    ...
    <div class="toolbar" style="position:fixed;top:0;left:0;right:0;padding:8px;background:#36393f;box-shadow: 0 1px 0 rgba(0,0,0,.2), 0 1.5px 0 rgba(0,0,0,.05), 0 2px 0 rgba(0,0,0,.05);">
        <div style="display:flex;flex-wrap:wrap;">
            <span>Authorization <a href="https://github.com/urifranklin/despair/blob/master/help/authToken.md" title="Help">?</a> <button id="getToken">auto</button><br>
                <input type="password" id="authToken" placeholder="Auth Token" autofocus>*<br>
                <span>Author <a href="https://github.com/urifranklin/despair/blob/master/help/authorId.md" title="Help">?</a> <button id="getAuthor">auto</button></span>
                <br><input id="authorId" type="text" placeholder="Author ID" priv></span>
            <span>Guild/Channel <a href="https://github.com/urifranklin/despair/blob/master/help/channelId.md" title="Help">?</a>
            ...
            <span>Range <a href="https://github.com/urifranklin/despair/blob/master/help/messageId.md" title="Help">?</a><br>
            ...
            <span>Search messages <a href="https://github.com/urifranklin/despair/blob/master/help/filters.md" title="Help">?</a><br>
    ...
    <pre style="margin-top:200px;font-size:0.75rem;font-family:Consolas,Liberation Mono,Menlo,Courier,monospace;">
        <center>Star this project on <a href="https://github.com/urifranklin/despair" target="_blank">github.com/urifranklin/despair</a>!\n\n
            <a href="https://github.com/urifranklin/despair/issues" target="_blank">Issues or help</a></center>
        </pre></body></html>`);
    ...
    $('#redact').onchange = e => {
        ...
        popup.alert('This will attempt to hide personal information, always double check before screenshotting.');
    };
